...
class BookInfo(db.Model):
    ...
    book_author = db.Column(db.String(255), unique=True, nullable=False)
    book_publisher = db.Column(db.String(255), unique=True, nullable=False)
    book_type = db.Column(db.String(255), unique=True, nullable=False)
...
class Book(db.Model):
    ...
    book_address = db.Column(db.String(255), unique=True, nullable=False)
